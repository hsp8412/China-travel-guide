<template>
  <router-link to="/cities/{{province.id}}" style="text-decoration: none">
    <div
      class="card row my-3"
...
export default {
  ...
  async created() {
    const provinceData = JSON.parse(JSON.stringify(this.province));
    console.log(JSON.parse(JSON.stringify(this.province)));
